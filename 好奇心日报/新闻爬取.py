...
def func(id=0):
    ...
    try:
        ...
        likenum = int(
            soup.find('span', 'num smart-count').attrs['data-origincount'])
        ...
        #这是新闻内容的爬取
        content = ''
        for child in soup.find('div', 'detail'):
        ...
        tuple1 = (id, title, likenum, date, comments)
...
def save(tuple1=None, list1=None):
    ...
    command1 = "insert into qdaily \
             (id,title,likenum,date,comments) values (?,?,?,?,?);"
