...
#获得范围
def getRange():
        baseSite = "http://www.chinesecome.com/xwhjy/index_0.jhtml"
...
def getLinkList(pla):
    try:
        baseSite = "http://www.chinesecome.com/xwhjy/index_【序号】.jhtml"
...
if __name__ == '__main__':
    ...
    # 创建工作簿
    file_name = "涉侨资讯_文化教育.xlsx"
    workbook = xlsxwriter.Workbook(file_name)

    # 创建工作表
    worksheet = workbook.add_worksheet('文化教育')
