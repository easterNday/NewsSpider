...
#获得范围
def getRange():
        baseSite = "http://www.chinesecome.com/xsszz/index_0.jhtml"
...
def getLinkList(pla):
    try:
        baseSite = "http://www.chinesecome.com/xsszz/index_【序号】.jhtml"
...
if __name__ == '__main__':
    ...
    # 创建工作簿
    file_name = "涉侨资讯_时事政治.xlsx"
    workbook = xlsxwriter.Workbook(file_name)

    # 创建工作表
    worksheet = workbook.add_worksheet('时事政治')
